...
<div class="topnav">
  ...
  <a href="my_car.php" class="active">MY CAR</a>
</div>
<div class="column">
...
<?php 
  if($_REQUEST["id"]){
    $car_code=$_REQUEST["id"];

    include("db.php");
    $rs=mysqli_query($con,"select * from car_short_details where car_code='$car_code'");
    while($r=mysqli_fetch_array($rs)){
    ?>
<form id="regForm" action="edit_my_car1.php?id=<?=$car_code?>" method="post" enctype="multipart/form-data">
  <!-- One "tab" for each step in the form: -->
  <p style="color:#FFFFFF; font-size:30px;" >Update Your Vehical Information</p>
  ...
  <select name="car_modal" id="modaal">
    <option value="<?=$r[4]?>"><?=$r[4]?></option>
  </select><br>
  <input type="text" name="dollar" placeholder="Car rate in dollar..." id="reg" value="<?=$r[5]?>"><br>
  <input type="text" name="miles" placeholder="Car running miles..." id="reg" value="<?=$r[6]?>"><br>
...
<option value="<?=$r[9]?>"><?=$r[9]?></option></select>
  ...
  <input type="text" name="exterior" placeholder="Exterior color...." id="reg" value="<?=$r[12]?>"><br>
  <input type="text" name="inerior" placeholder="Inerior color...." id="reg" value="<?=$r[13]?>"><br>
  <input type="text" name="stock" placeholder="ENTER CAR STOCK..." id="reg" value="<?=$r[14]?>"><br>
  <input type="text" name="vin" placeholder="Enter VIN number..." id="reg" value="<?=$r[15]?>"><br>
...
<?php
  $aa=mysqli_query($con,"select * from add_details where car_code='$r[1]'");
    ...
    ?>
  <input type="text" name="listing" placeholder="ENTEER LISTING TITLE..." id="reg" value="<?=$a[1]?>"><br>
  <input type="text" name="engine_type" placeholder="ENTER ENGINE TYPE..." id="reg"  value="<?=$a[2]?>"><br>
  <input type="text" name="cylinder" placeholder="ENTER NO. OF CYLINDER IN CAR....." id="reg"  value="<?=$a[3]?>"><br>
  <input type="text" name="engine_size" placeholder="ENGINE SIZE....." id="reg"  value="<?=$a[4]?>"><br>
  <input type="text" name="fuel_capacity" placeholder="FUEL CAPACITY.." id="reg"  value="<?=$a[5]?>"><br>
  <input type="text" name="wheel_base" placeholder="WHEEL BASE.." id="reg"  value="<?=$a[6]?>"><br>
  <input type="text" name="overall_length" placeholder="OVERALL LENGTH..." id="reg"  value="<?=$a[7]?>"><br>
  <input type="text" name="width" placeholder="WIDTH"  id="reg"  value="<?=$a[8]?>"><br>
  <input type="text" name="height" placeholder="HEIGHT" id="reg"  value="<?=$a[9]?>"><br>
  <input type="text" name="curb_weight" placeholder="CURB WEIGHT.." id="reg"  value="<?=$a[10]?>"><br>
  <input type="text" name="leg_room" placeholder="LEG ROOM...." id="reg"  value="<?=$a[11]?>"><br>
  <input type="text" name="head_room" placeholder="HEAD ROOM..." id="reg"  value="<?=$a[12]?>"><br>
  <input type="text" name="seating_capacity" placeholder="SEATING CAPACITY(STD).." id="reg"  value="<?=$a[13]?>"><br>
  <input type="text" name="features" placeholder="ENTER CAR FEATURES SEPARATE WITH COMMA...." id="reg"  value="<?=$a[14]?>"><br>
  <textarea rows="10" cols="140" name="description" placeholder="FULL DESCRIPTION IN SHORT PARAGRAPH...."><?=$a[15]?></textarea><br>
<?php }?>
   <input type="submit" value="Update Details" name="submit" class="search" style="border:none; border-radius: 4px;">
</form>
    <?php
