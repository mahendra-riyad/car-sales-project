...
<form action="" style="max-width:500px;margin:auto;">
  ...
  <div class="input-container">
    ...
    <input class="input-field" type="text" placeholder="PHONE NUMBER" name="phone">
  	...
  	<textarea cols="60" rows="6" name="comment"   style="border-radius:4px; background-color:#202020; color:#FFFFFF; border:none;">
	I would like to request more information about your 2014 MDX Acura with Stock Number #<?=$stock?>
	</textarea><br>
...
<a href="view_details.php?id=<?=$r[1]?>"><img src="uploads/<?=$r[1]?>0.JPG" class="img img-responsive" style="height:170px; width:100%; margin-top:-25px;"></a>
