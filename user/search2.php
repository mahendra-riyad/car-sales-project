...
$id=$_GET["id"];
$count=0;
 $rs=mysqli_query($con,"select * from car_short_details where drive='$id'");
...
<?php
  ...
  if($count==0){
  ?><p style="letter-spacing: 2px; word-spacing: 4px; color:#fff; padding: 20px;">No One Result Found For <i style="font-size: 24px; text-decoration: underline;"><?=$id?></i></p>
  <?php
  }
?>
</div></div>
