...
#car1 {
  background-color:#151515; margin-bottom:20px; margin-top:15px; padding:20px;
  text-decoration: none;
}
#car1:hover {
  background-color: #B70000;
...
<a href="edit_my_car.php?id=<?=$r[1] ?>"><button class="view-details2">Edit Details</button></a>
<a href=""><button class="view-details1">Remove Car</button></a>
</div></div>
