...
<div id="id01" class="modal">
  ...
  <div class="input-container" style="margin-top:60px;">
    ...
    <input class="input-field" type="text" placeholder="Email Address.." name="email_id">
  </div>
  ...
  <script type="text/javascript">
   $(document).ready(function(){
    $("#form_submit").click(function(){
     ...
     var data1='name='+name1 + '&email='+email1 + '&phone='+phone1 + '&comment='+comment1;
      $.ajax({
            type: "POST",
            url: "contact1.php",
            data: data1
   ...
   <p style="background-color: #181818; color:white; font-size: 24px;">CONTACTS US :-</p>
     <label style="margin-top: 20px;" id="label">Name(Required)</label>
    <input class="form-control" type="text" placeholder="NAME(REQUIRED)" id="name" name="name">
  <br>
  <label id="label2">Email Id(Required)</label>
    <input class="form-control" type="text" placeholder="EMAIL(REQUIRED)" name="email" id="email_id">
  <br>
  <label id="label2">Phone</label>
    <input class="form-control" type="text" placeholder="PHONE NUMBER" id="phone" name="phone">
  <br>
  <label id="label2">Message(Required)</label><br>
    <textarea cols="140" rows="10" name="comment" id="comment" style="border-radius:4px; color:#FFFFFF;">
  </textarea><br>
...
<div class="container-fluid">
  ...
  <p class="search" style="margin-top: 20px;">FIND BY VEHICLE TYPE</p>
